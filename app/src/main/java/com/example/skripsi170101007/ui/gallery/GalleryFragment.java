package com.example.skripsi170101007.ui.gallery;
        ...
        Simpan.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isEmpty(getCODE) || isEmpty(getName) || isEmpty(getBrand) || isEmpty(getCapacity) || isEmpty(getLocation) || isEmpty(getMaintenance)){
                    ...
                    */
                    getReference.child("Aset").child("Hvac").push()
                            .setValue(new data_hvac(getCODE, getName, getBrand, getCapacity, getLocation, getMaintenance))
...
//                                    Toast.makeText(getActivity(), "Data Tersimpan", Toast.LENGTH_SHORT).show();
                                    Intent i = new Intent(getActivity(), MyListData2.class);
                                startActivity(i);
                                }
                            });
                }
