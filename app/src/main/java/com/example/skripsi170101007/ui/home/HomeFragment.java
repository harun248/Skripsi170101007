package com.example.skripsi170101007.ui.home;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Simpan = (FloatingActionButton) root.findViewById(R.id.save);
        ...
        if(isEmpty(getCODE) || isEmpty(getName) || isEmpty(getBrand) || isEmpty(getCapacity) || isEmpty(getLocation) || isEmpty(getMaintenance)){
            ...
            Toast.makeText(getActivity(), "Data tidak boleh ada yang kosong", Toast.LENGTH_SHORT).show();
                    ...
                    */
            getReference.child("Aset").child("Electrical").push()
                    .setValue(new data_electrical(getCODE, getName, getBrand, getCapacity, getLocation, getMaintenance))
...
//                            Toast.makeText(getActivity(), "Data Tersimpan", Toast.LENGTH_SHORT).show();
                            Intent i = new Intent(getActivity(), MyListData1.class);
                            startActivity(i);
                        }
                    });
        }
...
//        });
        ...
        Showdata =(FloatingActionButton) root.findViewById(R.id.showdata);
