...
public class UpdateData2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Btn_calendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(UpdateData2.this, date, myCalendar
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isEmpty(cekCODE) || isEmpty(cekName) || isEmpty(cekBrand) || isEmpty(cekCapacity) || isEmpty(cekLocation) || isEmpty(cekMaintenance)){
                    Toast.makeText(UpdateData2.this, "Data tidak boleh ada yang kosong", Toast.LENGTH_SHORT).show();
                }else {
                    /*
                      Menjalankan proses update data.
                      Method Setter digunakan untuk mendapakan data baru yang diinputkan User.
                    */
                    data_hvac setHvac = new data_hvac();
                    ...
                    setHvac.setMaintenance(maintenanceBaru.getText().toString());
                    updateHvac(setHvac);
                }
            }
        });
    ...
    private void updateHvac(data_hvac hvac){
        ...
        database.child("Aset")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(UpdateData2.this, "Data Berhasil diubah", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
    }
